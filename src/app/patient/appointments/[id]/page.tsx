      ...
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        {apt.status === 'BOOKED' && (
          <div className="mt-8 pt-6 border-t border-gray-200">
            <h2 className="text-lg font-bold text-gray-900 mb-4">Pre-visit Summary (AI Generated)</h2>
            {apt.urgencyLevel && (
              <div className="mb-4">
        ...
        {apt.status === 'COMPLETED' && (
          <div className="mt-8 pt-6 border-t border-gray-200">
            <h2 className="text-lg font-bold text-gray-900 mb-4">Post-visit Summary</h2>
